...
EliteForce engine should add the pak9.pk3 to their baseEF directories.
If this README is from an archive (zip or bzip2) it should be included, too.
...
Once you have done all this, you must copy the engine from this project to
your main eliteforce installation directory where Raven's original
stvoyHM.exe file resides.
If this README is contained in a ZIP archive, you can just unpack it to your
EliteForce directory and it will get all paths correctly. Don't unpack it to
baseEF as you would do with maps but into the same path with stvoyHM.exe!
You can get the new engine here, too:
http://thilo.kickchat.com/efport-progress/bin/win32/
After unpacking, a new file named iostvoyHM-1.34.exe has been created. If
you want to use my improved engine you must start this one instead of the
original stvoyHM.exe.

You may have also noticed an OpenAL installer. OpenAL is a portable library
that provides 3d sound functions. This one is even EAX enabled though it is
not making use of these extensions.
...
If this README is contained in a .bz2 archive you can just unpack it to the
newly created directory.
Otherwise, just copy a build of this engine that you can get from
...
release in there and don't forget the new pak9.pk3!
