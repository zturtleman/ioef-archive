...
EliteForce engine should add the pak91.pk3 to their baseEF directories.
...
will find a new group in your start menu called "Elite Force Holomatch 1.36"
With shortcuts to run the game using the new patch and shortcuts to this
read me file.

After installing, a new file named iostvoyHM-1.36.exe has been created. If
...
http://thilo.kickchat.com/efport-progress/bin/linux/io_eliteforce-1.36.run
Run it in a shell like:
sh iostvoyHM-1.36.run
...
http://thilo.kickchat.com/efport-progress/patches/stvoyVM-bugfixes-1.36.diff
